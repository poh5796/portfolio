<div id="about" class="max-w-3xl mx-auto px-6 py-20 space-y-20">
  <!-- Bio Section -->
  ...
  <section class="space-y-6">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
      <!-- Reusable Skill Item -->
      {#each ['Node.js', 'TypeScript', 'SvelteKit', 'WebGL', 'Docker', 'PostgreSQL'] as skill}
        <div class="p-4 border border-gray-200 dark:border-gray-700 rounded text-center font-mono text-sm hover:border-black dark:hover:border-white transition cursor-default">
          {skill}
        </div>
      {/each}
    </div>
